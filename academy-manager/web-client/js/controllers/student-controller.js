(function(angular) {
  ...
  controller.$inject = ['$http', 'studentService', '$location', '$routeParams', '$mdToast','MessageService'];

  function controller($http, studentService, $location, $routeParams, $mdToast, messageService) {
    var ctrl = this;
